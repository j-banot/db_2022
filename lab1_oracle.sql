...
CREATE OR REPLACE PROCEDURE ADD_RESERVATION_V2(TRIP_ID IN TRIP.TRIP_ID % TYPE, PERSON_ID IN PERSON.PERSON_ID % TYPE) IS
...
BEGIN
    ...
    INTO VALID_PERSON
    FROM PERSON p
    WHERE ADD_RESERVATION_V2.PERSON_ID = P.PERSON_ID;
    ...
    INTO VALID_TRIP
    FROM TRIP t
    WHERE ADD_RESERVATION_V2.TRIP_ID = t.TRIP_ID
      AND t.NO_AVAILABLE_PLACES > 0
      AND t.TRIP_DATE > CURRENT_DATE;
    ...
    INSERT INTO RESERVATION(TRIP_ID, PERSON_ID, STATUS)
    VALUES (ADD_RESERVATION_V2.TRIP_ID,
            ADD_RESERVATION_V2.PERSON_ID,
            'N')
    RETURNING RESERVATION_ID
        INTO NEW_RESERVATION_ID;
    ...
    WHERE t.TRIP_ID = ADD_RESERVATION_V2.TRIP_ID;
